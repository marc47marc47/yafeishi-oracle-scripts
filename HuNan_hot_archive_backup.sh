$ cat /usr/openv/scripts/hot_archive_backup.sh

rman target / catalog rman11g/rman11g@rman11g msglog /usr/openv/scripts/hot_archive_backup.sh.out append
#!/bin/sh
...
export ORACLE_SID
$RMAN target $TARGET_CONNECT_STR catalog rman11g/rman11g@rman11g msglog $RMAN_LOG_FILE append << EOF
RUN {
ALLOCATE CHANNEL ch00 TYPE 'SBT_TAPE';
ALLOCATE CHANNEL ch01 TYPE 'SBT_TAPE';
SEND 'NB_ORA_POLICY=BOSSDB2_ORA_ARCH';
